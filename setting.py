...
subscribe_message = "После оформления подписки Вам будет доступно к подключению 5 устройств с трафиком по 100 GB на устройство\n\nПока подписка не доступна\nСкоро появится"

wishes_message = "Пожелания и отзывы отправляйте на почту\ndarianikonova11@gmail.com"
